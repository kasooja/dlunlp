 ...
 * @author K
 */
public class SuggDataIterator implements DataSetIterator {
	/**
	 * 
	 */
	 ...
	 */
	public SuggDataIterator(String dataDirectory, WordVectors wordVectors, int batchSize, int truncateLength, boolean train) throws IOException {
