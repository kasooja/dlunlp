...
public class Word2VecSentimentRNN {
	...
	public static final String DATA_PATH = "/home/kartik/git/dlunlp/dl4jsink/src/main/resources/Sent/aclImdbSample/";
	...
	public static void main(String[] args) throws Exception {
		...
		WordVectors wordVectors = WordVectorSerializer.loadTxtVectors(new File(WORD_VECTORS_PATH_GLOVE));
